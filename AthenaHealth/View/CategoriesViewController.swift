...
extension CategoriesViewController: UITableViewDelegate{
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let diseasesViewController = storyboard.instantiateViewController(withIdentifier: "DiseasesViewController") as! DiseasesViewController
        diseasesViewController.dataViewModel = dataViewModel
        navigationController?.pushViewController(diseasesViewController, animated: true)
    }
}
